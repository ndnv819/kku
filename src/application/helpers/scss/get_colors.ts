export const getColor = (
  ...
  const baseColor = {
    basic: {
      ...
      outline: 'bg-basic-transparent-8 border-basic-600 text-[#8f9bb3]',
      ghost: 'text-basic-800',
    },
    primary: {
      filled: 'bg-primary-500 text-basic-100',
      outline: 'bg-primary-transparent-8 border-primary-500 text-primary-500',
      ghost: 'text-primary-500',
    },
    success: {
      filled: 'bg-success-500 text-basic-100',
      outline: 'bg-success-transparent-8 border-success-500 text-success-500',
      ghost: 'text-success-500',
    },
    info: {
      filled: 'bg-info-500 text-basic-100',
      outline: 'bg-info-transparent-8 border-info-500 text-info-500',
      ghost: 'text-info-500',
    },
    warning: {
      filled: 'bg-warning-500 text-basic-100',
      outline: 'bg-warning-transparent-8 border-warning-500 text-warning-500',
      ghost: 'text-warning-500',
    },
    danger: {
      filled: 'bg-danger-500 text-basic-100',
      outline: 'bg-danger-transparent-8 border-danger-500 text-danger-500',
